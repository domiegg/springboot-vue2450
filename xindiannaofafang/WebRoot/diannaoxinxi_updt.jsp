...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateDiannaoxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改电脑信息<input type="hidden" name="id" value="${diannaoxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${diannaoxinxi.bianhao}';</script>	<script language="javascript">document.form1.mingcheng.value='${diannaoxinxi.mingcheng}';</script>	<script language="javascript">document.form1.pinpai.value='${diannaoxinxi.pinpai}';</script>	<script language="javascript">document.form1.xinghao.value='${diannaoxinxi.xinghao}';</script>	<script language="javascript">document.form1.peizhi.value='${diannaoxinxi.peizhi}';</script>	<script language="javascript">document.form1.kucun.value='${diannaoxinxi.kucun}';</script>	
					 </table>
			</form>
   </body>
</html>
