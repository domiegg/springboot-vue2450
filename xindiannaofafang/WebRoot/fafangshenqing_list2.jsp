...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="fafangshenqingList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bianhao}</td>    <td>${u.mingcheng}</td>    <td>${u.kucun}</td>    <td>${u.shenqingshuliang}</td>        <td>${u.riqi}</td>    <td>${u.gonghao}</td>    <td>${u.xingming}</td>    <td>${u.bumen}</td>    <td>${u.fafangzhuangtai}</td>        
                              ...
                              <td align="center"><a href="doUpdateFafangshenqing.do?id=${u.id }">编辑</a>  <a href="deleteFafangshenqing.do?id=${u.id }"
		 ...
		 <%
			String sql="select * from fafangshenqing where gonghao='"+(String)request.getSession().getAttribute("username")+"'  ";
...
while(RS_result.next()){
		...
		共计申请数量:<%=shenqingshuliangz%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="fafangshenqingList2.do?page=1" >首页</a>
             <a href="fafangshenqingList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="fafangshenqingList2.do?page=${page.page+1 }">下一页</a>
			<a href="fafangshenqingList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
